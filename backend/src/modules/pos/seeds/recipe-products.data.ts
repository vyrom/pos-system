...
export const INITIAL_INGREDIENTS_SEED: Ingredient[] = [
  // --- Coffee Beans ---
  { id: 'ing-1', name: 'Coffee Sayon', category: 'Coffee Beans', stock: 5000, uom: 'g', costPerUnit: 0.012, minStock: 500, icon: '☕' },
  { id: 'ing-2', name: 'Sakor Bean', category: 'Coffee Beans', stock: 5000, uom: 'g', costPerUnit: 0.0178, minStock: 500, icon: '☕' },

  // --- Dairy & Milk ---
  { id: 'ing-3', name: 'Fresh Milk', category: 'Dairy & Milk', stock: 20000, uom: 'ml', costPerUnit: 0.0021, minStock: 2000, icon: '🥛' },
  { id: 'ing-4', name: 'Sweeten Milk', category: 'Dairy & Milk', stock: 5000, uom: 'ml', costPerUnit: 0.0029, minStock: 500, icon: '🥛' },
  { id: 'ing-5', name: 'Kofi Evaporated milk', category: 'Dairy & Milk', stock: 5000, uom: 'ml', costPerUnit: 0.00222, minStock: 500, icon: '🥛' },
  ...
  // --- Powders & Tea ---
  { id: 'ing-24', name: 'Chocolate Powder', category: 'Powders & Tea', stock: 3000, uom: 'g', costPerUnit: 0.0168, minStock: 300, icon: '🍫' },
  { id: 'ing-25', name: 'Kofi Chocolate Powder', category: 'Powders & Tea', stock: 3000, uom: 'g', costPerUnit: 0.013, minStock: 300, icon: '🍫' },
  { id: 'ing-26', name: 'Kofi Matcha Powder', category: 'Powders & Tea', stock: 1500, uom: 'g', costPerUnit: 0.069, minStock: 200, icon: '🍵' },
  { id: 'ing-27', name: 'Green tea Powder', category: 'Powders & Tea', stock: 1500, uom: 'g', costPerUnit: 0.0745, minStock: 200, icon: '🍵' },
