...
export const INITIAL_INGREDIENTS_SEED: Ingredient[] = [
  // --- Coffee Beans ---
  { id: 'ing-1', name: 'Coffee Sayon', category: 'Coffee Beans', stock: 4000, uom: 'g', costPerUnit: 0.012, minStock: 500, icon: '☕' }, // 8 x 500g = 4,000g @ $6.00/500g = $48.00
  { id: 'ing-2', name: 'Sakor Bean', category: 'Coffee Beans', stock: 0, uom: 'g', costPerUnit: 0.0178, minStock: 500, icon: '☕' },

  // --- Dairy & Milk ---
  { id: 'ing-3', name: 'Fresh Milk', category: 'Dairy & Milk', stock: 4000, uom: 'ml', costPerUnit: 0.0019, minStock: 2000, icon: '🥛' }, // 4 x 1000ml = 4,000ml @ $1.90/1L = $7.60
  { id: 'ing-4', name: 'Sweeten Milk', category: 'Dairy & Milk', stock: 8000, uom: 'ml', costPerUnit: 0.00195, minStock: 500, icon: '🥛' }, // 4 x 2000ml = 8,000ml @ $3.90/2kg = $15.60
  { id: 'ing-5', name: 'Kofi Evaporated milk', category: 'Dairy & Milk', stock: 3600, uom: 'ml', costPerUnit: 0.0022222222, minStock: 500, icon: '🥛' }, // 4 x 900ml = 3,600ml @ $2.00/900ml = $8.00
  ...
  // --- Powders & Tea ---
  { id: 'ing-24', name: 'Chocolate Powder', category: 'Powders & Tea', stock: 2000, uom: 'g', costPerUnit: 0.0218, minStock: 300, icon: '🍫' }, // 4 x 500g = 2,000g @ $10.90/500g = $43.60
  { id: 'ing-25', name: 'Kofi Chocolate Powder', category: 'Powders & Tea', stock: 0, uom: 'g', costPerUnit: 0.0218, minStock: 300, icon: '🍫' },
  { id: 'ing-26', name: 'Kofi Matcha Powder', category: 'Powders & Tea', stock: 400, uom: 'g', costPerUnit: 0.079, minStock: 200, icon: '🍵' }, // 4 x 100g = 400g @ $7.90/100g = $31.60
  { id: 'ing-27', name: 'Green tea Powder', category: 'Powders & Tea', stock: 0, uom: 'g', costPerUnit: 0.079, minStock: 200, icon: '🍵' },
